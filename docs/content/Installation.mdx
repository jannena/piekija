...
4. (Mikäli backend toimii eri ositteessa kuin frontend, tiedostoon *client/globals.js* tulee muuttujiin baseUrl (muotoa //osoite.fi/api) ja wsBaseUrl (muotoa //osoite.fi/) muuttaa backendin URL-osoite. Tällöin on huomattava, että frontend sijaitsee hakemistossa *server/build*. Muutoin tätä vaihetta ei tarvita.)
