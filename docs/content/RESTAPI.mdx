...
## Records
<Template verb="GET" address="/api/record/:id" privileges={1}
...
<Template verb="POST" address="/api/record" privileges={2}
    ...
    parameters={[["type", "must be 'marc21'", true], ["data", "marc21 data", true]]}
...
## Users (me)
<Template verb="POST" address="/api/user/me" privileges={1}
    description="Gets loans and information of the logged-in user"
    returns="User loans and information"
    parameters={[]}
    errors={[]} />
